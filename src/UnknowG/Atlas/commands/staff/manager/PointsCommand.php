                    ...
                    if (isset($args[1])) {
                        if (in_array($args[1],["add", "del", "set"])) {
                            if (isset($args[2])) {
                                switch ($args[1]) {
                                    case "add":
                                        LeaguesAPI::addOffPoints($args[0],$args[2]);
                                        $player->sendMessage(Texts::$prefixStaff . "Vous avez ajouté(e) §6{$args[2]} §7points au joueur §6{$args[0]}");
                                        break;

                                    case "del":
                                        LeaguesAPI::delOffPoints($args[0],$args[2]);
                                        $player->sendMessage(Texts::$prefixStaff . "Vous avez retiré(e) §6{$args[2]} §7points au joueur §6{$args[0]}");
                                        break;

                                    case "set":
                                        LeaguesAPI::setOffPoints($args[0],$args[2]);
                                        $player->sendMessage(Texts::$prefixStaff . "Vous avez définie §6{$args[2]} §7points au joueur §6{$args[0]}");
                                        break;
                                }
                            } else {
                                $player->sendMessage(Texts::$prefixStaff . "Vous avez oublié l'argument §6pointsCount §7en position 2");
                            }
                        } else {
